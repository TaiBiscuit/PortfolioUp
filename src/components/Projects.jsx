                ...
                <div className="main-projects">
                    {
                        ...
                        <>
                            <a href={mainData[0].live} target='_blank' key={mainData[0].key}>
                            ...
                            <a href={mainData[1].live} target='_blank' key={mainData[1].key}>
                                ...
                                <div className="left-side-2">
                                    <div className="left-content-2">
                                        <div className="main-project-header-icon">
                                                        <p><FaFolder /></p>
                                                        <div className="main-links">
                                                            <a href={mainData[1].github} target='_blank'><FiGithub /></a>
                                                            <a href={mainData[1].live} target='_blank'><RiExternalLinkLine /></a>
                                                        </div>
                                        </div>
                            ...
                            <a href={mainData[2].live} target='_blank' key={mainData[2].key}>
                                ...
                                <div className="right-side-3">
                                    <div className="right-content-3">
                                        <div className="main-project-header-icon">
                                                        <p><FaFolder /></p>
                                                        <div className="main-links">
                                                            <a href={mainData[2].github} target='_blank'><FiGithub /></a>
                                                            <a href={mainData[2].live} target='_blank'><RiExternalLinkLine /></a>
                                                        </div>
                                        </div>
